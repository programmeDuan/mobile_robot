 ...
 *------------------------------------------------------------------
 * Constructed Function: YATViBePlus
 *
 * Summary:
...
=====================================================================
*/
YATViBePlus::YATViBePlus(int num_sam, int min_match, int r, int rand_sam)
{
    num_samples = num_sam;
 ...
 * 说明：释放样本库内存；
 *------------------------------------------------------------------
 * Destructor Function: ~YATViBePlus
 *
 * Summary:
 *   Release the memory of Sample Library.
=====================================================================
*/
YATViBePlus::~YATViBePlus(void)
{
    yatDeleteSamples();
}
...
=====================================================================
*/
void YATViBePlus::yatFrameCapture(Mat img)
{
    img.copyTo(Frame);
    if(img.channels() == 3)
    {
...
=====================================================================
*/
void YATViBePlus::yatProcessFirstFrame()
{
    if(Gray.empty())
    {
...
/*===================================================================
 * 函数名：yatCalcuUpdateModel
 * 说明：根据已经得到的分割模板，计算更新模板
 *
 * 返回值：void
 *------------------------------------------------------------------
 * Function: yatCalcuUpdateModel
 *
 * Summary:
...
=====================================================================
*/
void YATViBePlus::yatCalcuUpdateModel()
{
    //========================================================
        ...
        for(int j = 0; j < Gray.cols; j++)
        {
            ...
            if (UpdateModel.at<uchar>(i, j) <= 0)
            {
                ...
                if (random == 0)
                {
                    ...
                    yatUpdatePixSampleSumSquare(i, j, random, newVal);
                ...
                if (random == 0)
                {
                    ...
                    //====================================================================
                    if(samples_MaxInnerGrad[i][j] > 50)
                    {
                        continue;
                    }     
                    ...
                    // Set random pixel's Value for Sample Library//
                    random = rng.uniform(0, num_samples);
                    yatUpdatePixSampleSumSquare(row, col, random, newVal);
...
/*===================================================================
 * 函数名：yatUpdatePixSampleSumSquare
 * 说明：更新当前像素点样本集方差
 * 参数：
 *      int i：行数
 *      int j：列数
 ...
 * 返回值：void
 *------------------------------------------------------------------
 * Function: yatUpdatePixSampleSumSquare
 *
 * Summary:
...
=====================================================================
*/
void YATViBePlus::yatUpdatePixSampleSumSquare(int i, int j, int k, int val)
{
    double res = 0;
    // 更新当前像素点样本集平均值//
    // Update Average Value of Current Pixel's Sample Library//
    yatUpdatePixSampleAve(i, j, k, val);
 ...
 * 返回值：void
 *------------------------------------------------------------------
 * Function: yatUpdatePixSampleAve
 *
 * Summary:
...
=====================================================================
*/
void YATViBePlus::yatUpdatePixSampleAve(int i, int j, int k, int val)
{
    double res;
    // 计算原样本集灰度总值//
...
=====================================================================
*/
Mat YATViBePlus::yatGetSegModel()
{
    return SegModel;
}

/*===================================================================
 * 函数名：yatGetUpdateModel
 * 说明：获取更新模型二值图像；
 * 返回值：Mat
 *------------------------------------------------------------------
 * Function: yatGetUpdateModel
 *
 * Summary:
 *   get Foreground Model Binary Image.
 *
...
=====================================================================
*/
Mat YATViBePlus::yatGetUpdateModel()
{
    return UpdateModel;
}
...
/*===================================================================
 * 函数名：yatDeleteSamples
 * 说明：删除样本库；
 * 返回值：void
 *------------------------------------------------------------------
 * Function: yatDeleteSamples
 *
 * Summary:
...
=====================================================================
*/
void YATViBePlus::yatDeleteSamples()
{
    delete samples;
